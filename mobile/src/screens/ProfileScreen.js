        ...
        <View style={styles.idCardContainer}>
          ...
          <View style={styles.idCardHeader}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={styles.idCardHeaderTitle} numberOfLines={1}>{editCollege || 'School / College'}</Text>
            </View>
          ...
          {isEditingCard ? (
            ...
            <View style={styles.idCardBody}>
              ...
              <View style={styles.idCardRight}>
                ...
                <Text style={styles.idCardLabel}>CLASS / BRANCH</Text>
                <Text style={styles.idCardValue} numberOfLines={1}>{profile.branch || 'Not Set'}</Text>
                <Text style={styles.idCardLabel}>GRADE / SEMESTER</Text>
