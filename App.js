  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/invalid-email') {
        friendlyMessage = 'Invalid email structure.';
      } else if (err.code === 'auth/user-not-found' || err.code === 'auth/wrong-password' || err.code === 'auth/invalid-credential') {
        friendlyMessage = 'Incorrect credentials. Try again!';
      }
        ...
        <View style={styles.authContainer}>
          <Animated.View style={[
            ...
            <View style={styles.inputGroup}>
              <Text style={[styles.label, emailFocused && styles.labelFocused]}>College Email</Text>
              <TextInput 
        ...
        <Animated.View style={{ flex: 1, transform: [{ translateX: slideStepAnim }] }}>
          {obStep === 1 && (
            <ScrollView contentContainerStyle={styles.obContent}>
              ...
              <View style={styles.obInputGroup}>
                <Text style={styles.obLabel}>College / Institute</Text>
                <TextInput 
                  style={styles.obInput}
                  value={obCollege}
              ...
              <View style={styles.obInputGroup}>
                <Text style={styles.obLabel}>Branch / Stream</Text>
                <TextInput 
                  style={styles.obInput}
                  value={obBranch}
              ...
              <View style={styles.obInputGroup}>
                <Text style={styles.obLabel}>Current Semester</Text>
                <TextInput 
                  style={styles.obInput}
                  value={obSemester}
            ...
            <ScrollView contentContainerStyle={styles.obContent}>
              ...
              <View style={styles.obButtonRow}>
                ...
                <TouchableOpacity style={[styles.obPrimaryBtn, { flex: 1 }]} onPress={() => handleOnboardingNext(3)}>
                  <Text style={styles.obPrimaryBtnText}>Next: Goals →</Text>
                </TouchableOpacity>
              </View>
            </ScrollView>
          )}
